...
const discordId = "578073643125571604";
...
const reloadUser = async (data) => {
  ...
  $('div-img.avatar').css('background-image', `url(https://cdn.discordapp.com/attachments/1012336120962498630/1023687862853582868/b6bcd27b9ae9899e05a145491eea7138.jpg)`).removeAttr('loading');
  ...
  <a class="discord" href="https://discord.gg/oduldiyari" target="_blank">Discord</a>`);
  ...
  const socials = [
    {
      ...
      href: 'https://instagram.com/erentkss',
      tippy: 'Instagram'
    },
    {
    ...
    },
    {
      ...
      href: `https://discord.gg/oduldiyari`,
      tippy: 'Discord'
    },
    {
      ...
      href: 'https://github.com/erenizm74',
      tippy: 'GitHub'
    }
  ];
